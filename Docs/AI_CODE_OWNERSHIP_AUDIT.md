...
- **Current repo:** https://github.com/CapstoneDesign-Spring2026-UlsanCollege/BudgetBrain  
- **Current demo link:** *(Not deployed yet)*  
...
- **Feature 1:** User registration and login using email/password with JWT authentication  
- **Feature 2:** Dashboard displays financial data and summaries  
- **Feature 3:** Users can create and manage transactions stored in MongoDB  
...
| Code area | File / folder | What it does | Owner | Evidence |
|---|---|---|---|---|
...
| Area | AI tool | AI contribution | Human verification | Evidence |
|---|---|---|---|---|
...
| Authentication | ChatGPT | JWT + bcrypt logic | Debugged issues | API |

---

## 7) Bugs / Unreliable Features

| Bug / problem | Severity | Evidence | Owner | Next action |
|---|---|---|---|---|
| MongoDB connection failed | P0 | Error logs | Sunil | Fix URI/IP access |
| Server crash (`app not defined`) | P1 | Node error | Bidhan | Fix server.js |
...
| Student | Owned area | Can explain? | Evidence | Needs help with |
|---|---|---|---|---|
...
1. Fix MongoDB connection (Atlas / Compass)  
2. Ensure backend runs without crashing  
3. Connect frontend with backend APIs properly  
